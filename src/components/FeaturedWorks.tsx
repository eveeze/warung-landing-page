        ...
        <div className="flex flex-col gap-24">
          ...
          {products[0] && (
            <div className="w-full xl:w-[90%] group cursor-pointer flex flex-col">
              <div className="w-full aspect-square bg-forest-mid rounded-2xl md:rounded-[2rem] overflow-hidden relative mb-4">
        ...
        <div className="flex flex-col gap-16 lg:gap-32 lg:pt-12">
          ...
          {products[1] && (
            <div className="w-full md:w-[80%] lg:w-[95%] xl:w-[85%] self-end group cursor-pointer flex flex-col">
              <div className="w-full aspect-[4/3] bg-forest-mid rounded-2xl md:rounded-[2rem] overflow-hidden relative mb-4">
          ...
          {products[2] && (
            <div className="w-full md:w-[70%] lg:w-[80%] lg:-ml-12 group cursor-pointer flex flex-col">
              <div className="w-full aspect-[3/4] bg-forest-mid rounded-2xl md:rounded-[2rem] overflow-hidden relative mb-4">
