    ...
    >
      <div className="w-full px-6 flex-1 flex flex-col justify-center">
        ...
        <motion.div
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
          transition={{ duration: 1, ease: [1, 0, 0, 1], delay: 0.5 }}
          style={{ originX: 0 }}
        ...
        >
          <h1 className="text-[clamp(6rem,22vw,28rem)] font-heading font-black tracking-tighter uppercase text-white leading-none text-center">
            Manto™
          </h1>
        </motion.div>
      </div>
